...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<div class="entry-meta">
			<ul class="entry-agenda">
				...
				<li class="agenda-time"><span aria-hidden="true" class="icon-clock"></span><?php echo $time; ?></li>
				<?php endif; ?>
				
				<?php if ( $location = get_post_meta( $post->ID, '_onde', true ) ) : ?>
				<li class="agenda-location"><span aria-hidden="true" class="icon-location"></span><?php echo $location; ?></li>
				<?php endif; ?>
				
				<?php if ( $link = get_post_meta( $post->ID, '_link', true ) ) : ?>
				<li class="agenda-link"><span aria-hidden="true" class="icon-globe"></span><a href="<?php echo esc_url( $link ); ?>"><?php _ex( 'More info', 'Agenda', 'fluxo' ); ?></a></li>
				<?php endif; ?>
			</ul>
		</div><!-- .entry-meta -->
	</header><!-- .entry-header -->
	...
	<footer class="entry-meta">
		<?php edit_post_link( __( 'Edit', 'fluxo' ), '<span class="edit-link">', '</span>' ); ?>
	</footer><!-- .entry-meta -->
