...
class EmRede
{
	function __construct()
	{
		$this->_customs = array(
				...
				(
						...
						'title' => __('Nome do projeto', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),*/
				'Fórum' => array
				(
						'slug' => 'forum',
						'title' => __('Fórum', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'Domínios' => array
				(
						'slug' => 'dominios',
						'title' => __('Domínios', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'Responsável pelo preenchimento' => array
				(
						'slug' => '_responsavel-pelo-preenchimento',
						'title' => __('Responsável pelo preenchimento', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'Situação' => array
				(
				...
				(
						...
						'tip' => __('', 'fluxo'),
						'type' => 'radio',
						'values' => array('S' => __('Sim', 'fluxo' ), 'N' => __('Não', 'fluxo' ) )
				),
				'Email' => array
				(
						'slug' => 'email',
						'title' => __('Email', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'Telefone' => array
				(
						'slug' => 'telefone',
						'title' => __('Telefone', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'Facebook' => array
				(
						'slug' => 'facebook',
						'title' => __('Facebook', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				/*'Cidade' => array
				(
						'slug' => 'Cidade',
						'title' => __('Cidade', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'Estado' => array
				(
						'slug' => 'Estado',
						'title' => __('Estado', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),*/
				'País' => array
				(
				...
				(
						'slug' => 'endereco',
						'title' => __('Endereço', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'Data de Criação' => array
				(
						'slug' => 'data-de-criacao',
						'title' => __('Data de Criação', 'fluxo'),
						'tip' => __('', 'fluxo'),
						'type' => 'date',
				),
				/*'location' => array
				...
				(
						'slug' => '_blog_id',
						'title' => __('blog_id', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'own_domain' => array
				(
						'slug' => 'own_domain',
						'title' => __('own_domain', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'template' => array
				(
				...
				(
						'slug' => '_current_theme',
						'title' => __('current_theme', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'user_email' => array
				(
						'slug' => 'user_email',
						'title' => __('E-mail do usuário', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'display_name' => array
				(
						'slug' => 'display_name',
						'title' => __('Nome do usuário', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'user_url' => array
				(
						'slug' => 'user_url',
						'title' => __('Site do usuário', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'mídias' => array
				(
						'slug' => '_midias',
						'title' => __('mídias', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'eventos' => array
				(
						'slug' => '_eventos',
						'title' => __('eventos', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
				'newletters' => array
				(
						'slug' => '_newletters',
						'title' => __('newletters', 'fluxo'),
						'tip' => __('', 'fluxo'),
				),
	...
	function Add_custom_Post()
	{
		$labels = array
		(
				'name' => __('em Rede','fluxo'),
				'singular_name' => __('em Rede','fluxo'),
				'add_new' => __('Add new','fluxo'),
				'add_new_item' => __('Add new em Rede','fluxo'),
				'edit_item' => __('Edit em Rede','fluxo'),
				'new_item' => __('New em Rede','fluxo'),
				'view_item' => __('View em Rede','fluxo'),
				'search_items' => __('Search em Rede','fluxo'),
				'not_found' =>  __('em Rede not found','fluxo'),
				'not_found_in_trash' => __('em Rede not found in the trash','fluxo'),
				'parent_item_colon' => '',
				'menu_name' => __('em Rede','fluxo')
	
		);
	
		$args = array
		(
				'label' => __('em Rede','fluxo'),
				'labels' => $labels,
				'description' => __('em Rede','fluxo'),
				'public' => true,
				...
				'register_meta_box_cb' => array($this, 'fluxo_emrede_custom_meta'), // função para chamar na edição
	...
	function fluxo_emrede_custom_meta()
	{
		add_meta_box("emrede_meta", __("Detalhes do ponto em Rede", 'fluxo'), array($this, 'emrede_meta'), 'emrede', 'side', 'default');
		add_meta_box("second_image_meta", __("Imagens do ponto em Rede", 'fluxo'), array($this, 'second_image_meta'), 'emrede', 'side', 'default');
	}
	...
	function getFields()
	{
		$post = array(
			'post_title' => array(
				'slug' => 'post_title',
				'title' => __('Nome do Núcleo ou Artista Pesquisador', 'fluxo'),
				'tip' => '',
				'required' => true,
				'buildin' => true
			),
			'post_content' => array(
				'slug' => 'post_content',
				'title' => __('Descreva a pesquisa do seu núcleo', 'fluxo'),
				'tip' => __('Maximum 2000 characters', 'fluxo'),
				'required' => true,
				//'type' => 'wp_editor',
				'type' => 'textarea',
				'rows' => 10,
		...
		foreach ($this->_customs as $key => $campo )
		{
			...
			/*switch ($type)
			{
				case 'dropdown-meses-anos':
					$dado = array_key_exists("$slug-anos", $custom) ? array_pop($custom["$slug-anos"]).__(" anos", 'fluxo') : '';
					if(array_key_exists("$slug-meses", $custom))
					{
						if(strlen($dado) > 0 ) $dado .= __(' e ', 'fluxo');
						$dado .= array_pop($custom["$slug-meses"]).__(" meses", 'fluxo');
					}
				case 'input':
				case 'date':
				default:
			...
			{
				$_REQUEST[$campo['slug'].'-anos'] = array_key_exists("$slug-anos", $custom) ? array_pop($custom["$slug-anos"]).__(" anos", 'fluxo') : '';
				if(array_key_exists("$slug-meses", $custom))
				{
					$_REQUEST[$campo['slug'].'-meses'] = array_pop($custom["$slug-meses"]).__(" meses", 'fluxo');
				}
			}
	...
	function second_image_meta($post)
	{
		...
		?>
		<p>
		    <label for="meta-image" class="fluxo-second-image-meta"><?php _e( 'Segunda Imagem', 'fluxo' )?></label>
		    <input type="text" name="thumbnail2" id="meta-image" value="<?php if ( isset ( $stored_meta ) ) echo $stored_meta; ?>" />
		    <input type="button" id="meta-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'fluxo' )?>" />
		</p>
		<?php
		$stored_meta = get_post_meta( $post->ID, 'thumbnail3', true)
		?>
		<p>
		    <label for="meta-image" class="fluxo-second-image-meta"><?php _e( 'Terceira Imagem', 'fluxo' )?></label>
		...
		?>
		<p>
		    <label for="meta-image" class="fluxo-second-image-meta"><?php _e( 'Foto do Responsável', 'fluxo' )?></label>
	...
	function admin_enqueue_scripts()
	{
		...
		if( $typenow == 'emrede' )
		{
			...
			array(
			'title' => __( 'Choose or Upload an Image', 'fluxo' ),
			'button' => __( 'Use this image', 'fluxo' ),
			)
			);
				...
				case 'dropdown-ano':
					...
					<div class="emrede-item emrede-item-dropdown <?php echo $id; ?>">
						<label for="<?php echo $id ?>" class="emrede-item-label">
							...
							class="<?php echo $input_class ?>"
							name="<?php echo $id ?>">
								<option value="" <?php echo array_key_exists($id, $_REQUEST)? '' : 'selected="selected"'; ?> ><?php echo esc_attr_x('Selecione', 'fluxo' ); ?></option>
								<?php
					...
					<div class="emrede-item emrede-item-dropdown <?php echo $id; ?>">
						<label for="<?php echo $id ?>" class="emrede-item-label">
							...
							name="<?php echo "$id-meses"; ?>">
								<option value="" <?php echo array_key_exists("$id-meses", $_REQUEST) ? '' : 'selected="selected"';?> ><?php echo esc_attr_x('Meses', 'fluxo' ); ?></option>
								<?php
									for($i = 1; $i < 13; $i++)
									{
										?>
							...
							name="<?php echo "$id-anos"; ?>">
								<option value="" <?php echo array_key_exists("$id-anos", $_REQUEST) ? '' : 'selected="selected"';?> ><?php echo esc_attr_x('Anos', 'fluxo' ); ?></option>
								<?php
									for($i = 1; $i < 101; $i++)
									{
										?>
	...
	function roles_install($permissoes)
	{
		...
		foreach ($permissoes as $nome => $permisao)
		{
			if($permisao['Novo'] == true)
			{
				...
				if(!is_object($Role))
				{
					throw new Exception(sprintf(__('Permissão original (%s) não localizada','fluxo'),$permisao['From']));
				}
			...
			if(!is_object($Role))
			{
				throw new Exception(sprintf(__('Permissão %s não localizada','fluxo'),$nome));
			}
